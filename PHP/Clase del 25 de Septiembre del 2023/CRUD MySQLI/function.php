...
{ // Función para ejecutar nuestra consulta recibiendo como parámetro la consulta SQL ($query)
...
{ // Función para mostrar los datos de un registro de la base de datos
