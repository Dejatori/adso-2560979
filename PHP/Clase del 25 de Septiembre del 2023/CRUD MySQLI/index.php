...
<table border="1" width="50%">
    ...
    <form action="" method="post">
        <tr>
            ...
            <!-- Creamos un campo oculto para enviar el Id_Producto -->
            <td><input name="Descripcion" type="text" placeholder="Descripcion"></td>
            <!-- Creamos un campo para ingresar la Descripcion -->
            <td><input name="Precio_Unitario" type="text" placeholder="Precio_Unitario"></td>
            <!-- Creamos un campo para ingresar el Precio_Unitario -->
            <td><input name="Stock" type="text" placeholder="Stock"></td>
            <!-- Creamos un campo para ingresar el Stock -->
            <td>
