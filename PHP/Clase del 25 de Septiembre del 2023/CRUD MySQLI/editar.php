...
<form action="" method="post">
	<tr>
    <input name="Id_Producto" type="hidden" value="<?php echo $row->Id_Producto;?>" placeholder="Id_Producto"> <!-- Creamos un campo oculto para enviar el Id_Producto -->
    <td><input name="Descripcion" type="text" value="<?php echo $row->Descripcion;?>" placeholder="Descripcion"></td> <!-- Mostramos el campo Descripcion -->
	<td><input name="Precio_Unitario" type="text" value="<?php echo $row->Precio_Unitario;?>" placeholder="Precio_Unitario"></td> <!-- Mostramos el campo Precio_Unitario -->
	<td><input name="Stock" type="text" value="<?php echo $row->Stock;?>" placeholder="Stock"></td>	<!-- Mostramos el campo Stock -->
    <td>
	<select name="Id_Medida" id="Id_Medida"> <!-- Creamos el select para mostrar las unidades de medida -->
    ...
    <td></td>
    <td></td>
    <td><input type="submit" name="submit" class="btn btn-primary" value="submit"></td> <!-- Creamos el botón para enviar los datos del formulario -->
	</tr>		
</form>
</table>
