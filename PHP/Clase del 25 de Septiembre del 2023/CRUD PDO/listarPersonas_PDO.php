	...
	<table>
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="<?php echo "editar.php?Id_Persona=" . $personal->Id_Persona ?>">Editar</a></td> <!-- Este enlace redirecciona a editar.php -->
				<td><a href="<?php echo "eliminar.php?Id_Persona=" . $personal->Id_Persona ?>">Eliminar</a></td> <!-- Este enlace redirecciona a eliminar.php -->
			</tr>
