...
<table border="1" width="50%">
	...
	<tr>
	<input type="hidden" name="Id_Persona" placeholder="Id_Persona"> <!-- Este campo es invisible pero es necesario para guardar el Id_Persona de la persona a editar -->
    <td><input name="Nombre" required type="text" id="Nombre" placeholder="Nombre"></td> <!-- El campo "Nombre" tiene como valor por defecto el nombre de la persona a editar -->
    <td><input name="Apellido" required type="text" id="Apellido" placeholder="Apellido"></td> <!-- El campo "Apellido" tiene como valor por defecto el apellido de la persona a editar -->
    <td>
	...
	<td><input name="Nro_Dcto" type="text" placeholder="Nro_Dcto"></td> <!-- El campo "Nro_Dcto" tiene como valor por defecto el Nro_Dcto de la persona a editar -->
	</tr>	
