...
SET SQL_MODE = "NO_AUTO_VALUE_ON_ZERO"; -- Elimina el modo de valor cero para las tablas AUTO_INCREMENT
START TRANSACTION; -- Inicia una transacción
SET time_zone = "+00:00"; -- Establece la zona horaria predeterminada
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci; -- Establece el motor de la tabla (InnoDB = Motor de base de datos, DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci = Codificacion de caracteres)
...
(1, '2023-09-15 09:30:31', 1, 1, 400, 1, 3000.5, 1200200),
...
CREATE TABLE `personas` ( -- Crea la tabla personas
...
CREATE TABLE `productos` ( -- Crea la tabla productos
...
CREATE TABLE `tipo_documento` ( -- Crea la tabla tipo_documento
...
CREATE TABLE `unidades_medida` ( -- Crea la tabla unidades_medida
...
ALTER TABLE `compras`
  ...
  ADD KEY `Id_Persona` (`Id_Persona`); -- Crea el indice id_persona sobre el campo id_persona
...
ALTER TABLE `personas` 
  ...
  ADD KEY `Id_TipoDcto_3` (`Id_TipoDcto`); -- Crea el indice id_tipodcto_3 sobre el campo id_tipodcto
...
ALTER TABLE `tipo_documento`
  ADD PRIMARY KEY (`id_TipoDcto`); -- Crea el indice id_tipodcto (PRIMARY KEY = Clave primaria) sobre el campo id_tipodcto
...
ALTER TABLE `unidades_medida`
  ADD PRIMARY KEY (`Id_Unidad`); -- Crea el indice id_unidad (PRIMARY KEY = Clave primaria) sobre el campo id_unidad
...
ALTER TABLE `compras`
  MODIFY `Consecutivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4; -- Establece el auto_increment del campo consecutivo en 4 (AUTO_INCREMENT=4)
...
ALTER TABLE `personas`
  MODIFY `Id_Persona` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4; -- Establece el auto_increment del campo id_persona en 4 (AUTO_INCREMENT=4)
...
ALTER TABLE `productos`
  MODIFY `Id_Producto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15; -- Establece el auto_increment del campo id_producto en 15 (AUTO_INCREMENT=15)
...
ALTER TABLE `tipo_documento`
  MODIFY `id_TipoDcto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3; -- Establece el auto_increment del campo id_tipodcto en 3 (AUTO_INCREMENT=3)
...
ALTER TABLE `unidades_medida`
  MODIFY `Id_Unidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29; -- Establece el auto_increment del campo id_unidad en 29 (AUTO_INCREMENT=29)
